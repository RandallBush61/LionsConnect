...
namespace LionsConnect.Migrations
{
    public partial class kevIsSus : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LionEntry", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LionEntry_ApplicationUser_UserNameId",
